...
export const INDUSTRIAL_FEEDS: IndustrialFeed[] = [
  ...
  { name: 'Pig Grower Pellets', animal: ['Pig'], subSpecies: ['Grower'], nutrients: { energy: 300, protein: 16, fat: 4, fiber: 6, calcium: 0.7, phosphorus: 0.5 }, pricePerKg: 33 },
...
export const NUTRITIONAL_TARGETS: { [key: string]: AnimalTargets } = {
  ...
  Pig: {
    ...
    Finisher: [
      ...
      { name: 'Crude Fiber (g)', target: 7 },
      { name: 'Calcium (g)', target: 0.6 },
  ...
  Quail: {
    ...
    Layer: [
      { name: 'Energy (kcal)', target: 270 },
      { name: 'Protein (g)', target: 18 },
      { name: 'Crude Fiber (g)', target: 5 },
      { name: 'Calcium (g)', target: 2.2 },
      { name: 'Phosphorus (g)', target: 0.35 },
    ],
  },
   Rabbit: {
    Fryer: [
  ...
  Cow: {
    'Beef Cattle': [
      { name: 'Energy (kcal)', target: 250 },
      { name: 'Protein (g)', target: 12 },
      { name: 'Crude Fiber (g)', target: 20 },
      { name: 'Calcium (g)', target: 0.6 },
      { name: 'Phosphorus (g)', target: 0.35 },
    ],
    'Dairy Cow': [
      { name: 'Energy (kcal)', target: 265 },
      { name: 'Protein (g)', target: 16 },
      { name: 'Crude Fiber (g)', target: 18 },
      { name: 'Calcium (g)', target: 0.8 },
      { name: 'Phosphorus (g)', target: 0.45 },
  ...
  Turkey: {
    'All': [
      ...
      { name: 'Protein (g)', target: 20 },
      { name: 'Crude Fiber (g)', target: 5 },
      { name: 'Calcium (g)', target: 1.2 },
      { name: 'Phosphorus (g)', target: 0.5 },
    ],
  },
  Tilapia: {
    'Fingerling': [
      { name: 'Energy (kcal)', target: 310 },
      { name: 'Protein (g)', target: 30 },
      { name: 'Crude Fiber (g)', target: 4 },
      { name: 'Calcium (g)', target: 1.5 },
      { name: 'Phosphorus (g)', target: 1.0 },
    ],
    'Grow-out': [
      { name: 'Energy (kcal)', target: 300 },
      { name: 'Protein (g)', target: 25 },
      { name: 'Crude Fiber (g)', target: 5 },
      { name: 'Calcium (g)', target: 1.2 },
      { name: 'Phosphorus (g)', target: 0.8 },
    ],
  }
};